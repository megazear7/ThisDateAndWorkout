...
$("#1750").mouseenter(function(){
	...
	$("#thepointeryear").animate({left:x,top:"157px"},"slow");});
$("#1750").mouseleave(function(){
	$("#1750timeline").animate({height:'toggle'});
	$("#theuppointer").toggle();
	year_value=document.getElementById("year_holder").value;
	year=parseInt(year_value);
	year=((year+1250)*.2)+330;
	x=year.toString();
	x=x+"px";
	$("#thepointeryear").animate({left:x,top:"207px"},"slow");});
...
$("#1250BC").mouseleave(function(){
	...
	x=year.toString();
	x=x+"px";
	$("#thepointerpointer").animate({left:x,top:"207px"},"slow");});
});
...
<p2 id="thepointeryear" style="position:relative;z-index:2;top:207px;right:-346px;"></p2>
<!-- This is the pointer image -->
<div class="pointer" id="thepointer" style="position:relative;top:206px;right:-345px;"><img src="pointer.png" alt="darn" /></div>

<!-- This is the timeline image -->
<div class="timeline">

<img src="theuppointer.png" id="theuppointer" style="position:absolute;z-index:1;display:none;top:-75;right:361px" />

<img src="1750timeline.png" id="1750timeline" style="position:absolute;top:-95px;right:320px;display:none;"/>
<img src="1500timeline.png" id="1500timeline" style="position:absolute;top:-95px;right:370px;display:none;"/>
<img src="1250timeline.png" id="1250timeline" style="position:absolute;top:-95px;right:420px;display:none;"/>
<img src="1000timeline.png" id="1000timeline" style="position:absolute;top:-95px;right:470px;display:none;"/>
<img src="750timeline.png" id="750timeline" style="position:absolute;top:-95px;right:520px;display:none;"/>
<img src="500timeline.png" id="500timeline" style="position:absolute;top:-95px;right:570px;display:none;"/>
<img src="250timeline.png" id="250timeline" style="position:absolute;top:-95px;right:620px;display:none;"/>
<img src="0timeline.png" id="0timeline" style="position:absolute;top:-95px;right:670px;display:none;"/>
<img src="250bctimeline.png" id="250BCtimeline" style="position:absolute;top:-95px;right:720px;display:none;"/>
<img src="500bctimeline.png" id="500BCtimeline" style="position:absolute;top:-95px;right:770px;display:none;"/>
<img src="750bctimeline.png" id="750BCtimeline" style="position:absolute;top:-95px;right:820px;display:none;"/>
<img src="1000bctimeline.png" id="1000BCtimeline" style="position:absolute;top:-95px;right:870px;display:none;"/>
<img src="1250bctimeline.png" id="1250BCtimeline" style="position:absolute;top:-95px;right:920px;display:none;"/>
...
<img src="timeline 1000 year counters.png" style="position:relative;top:68px;right:377px;"/>
